...
const ContactUsByCall = () => {
  return (
    <div className="px-27 mb-10 ">
      <div className="text-black p-14 bg-[url(/scrollImg/cta_bg.svg)] bg-[position:100%_10%] bg-contains   shadow-[0px_8px_30px_0px_rgba(0,0,0,0.1)] ">
        <div className="flex  md:flex-row justify-center  items-center gap-5">
          ...
          <a href="mailto:info@ecomarray.com">
            <button className=" delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-95 border border-blue-600 rounded-4xl px-12 py-4 text-xl mt-9 font-semibold bg-blue-50 hover:bg-red-500 transition">
              REQUEST A CALL-BACK
            </button>
          </a>
        </div>
